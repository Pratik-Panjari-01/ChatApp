...
const ChatContainer = () => {
  ...
  const { messages, sendMessage, getMessages, selectedUser,
    setSelectedUser} = useContext(ChatContext);
  ...
  return selectedUser ? (
      ...
      <div className="flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pd-6">
        ...
        <div className="absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3">
          <div className="flex-1 flex items-center bg-gray-100/12 px-3 rounded-full">
            ...
            value={input} onKeyDown={(e)=> e.key==='Enter' ? handleSendMessage(e) : null} className="flex-1 text-sm p-3 border-none rounded-lg outline-none
    ...
    >
      ...
      <p className="test-lg font-medium text-white">Chat anytime, anywhere</p>
    </div>
  );
};
